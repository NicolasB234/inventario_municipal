...
if ($stmt->execute()) {
    ...
    echo "<p><strong>¡MUY IMPORTANTE!:</strong> Por seguridad, borra este archivo (reset_admin_password.php) y el archivo test_password.php de tu servidor ahora mismo.</p>";
} else {
